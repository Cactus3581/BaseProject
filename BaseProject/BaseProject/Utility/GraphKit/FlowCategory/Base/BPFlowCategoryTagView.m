...
#import "BPFlowCategoryViewCell.h"
#import "NSString+BPAdd.h"
#import "UIView+BPAdd.h"
#import "BPFlowCategoryViewProperty.h"

@interface BPFlowCategoryTagView ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation BPFlowCategoryTagView
...
- (void)bp_initializeUI{
    ...
    [mainView registerClass:[BPFlowCategoryViewCell class] forCellWithReuseIdentifier:@"BPFlowCategoryViewCell"];
...
- (void)bp_interpolationForItemsWithRatio:(CGFloat)ratio{
    ...
    for (BPFlowCategoryViewCell *cell in _mainView.visibleCells) {
        [cell bp_updateCell];
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    BPFlowCategoryViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"BPFlowCategoryViewCell" forIndexPath:indexPath];
