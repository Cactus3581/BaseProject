...
@interface BPSpecificFlowCategoryView ()<UICollectionViewDataSource, UICollectionViewDelegate, BPFlowCategoryTagViewDelegate>
...
@implementation BPSpecificFlowCategoryView
...
//        self.edgeSpacing = leftEdge;
        ...
        [self.categoryView bp_simpleRealoadData];
    }
