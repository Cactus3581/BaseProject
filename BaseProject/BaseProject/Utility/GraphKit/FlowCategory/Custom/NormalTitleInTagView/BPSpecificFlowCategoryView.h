...
@class BPSpecificFlowCategoryView;

@protocol BPSpecificFlowCategoryViewDelegate <NSObject>
...
/** 滑动中*/
- (void)flowCategoryViewDidScroll:(BPSpecificFlowCategoryView *)flowCategoryView;

/** 即将结束滑动*/
- (void)flowCategoryViewDidEndDecelerating:(BPSpecificFlowCategoryView *)flowCategoryView;

@end


@interface BPSpecificFlowCategoryView : UIView

/**vc缓存*/
@property (nonatomic, strong,readonly) NSMutableDictionary *vcCacheDic;
/**代理*/
@property (nonatomic, weak) id<BPSpecificFlowCategoryViewDelegate>delegate;
/**顶部高度*/
