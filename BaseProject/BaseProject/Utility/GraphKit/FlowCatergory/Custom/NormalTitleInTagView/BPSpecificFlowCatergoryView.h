...
@class BPSpecificFlowCatergoryView;

@protocol BPSpecificFlowCatergoryViewDelegate <NSObject>
...
/** 滑动中*/
- (void)flowCatergoryViewDidScroll:(BPSpecificFlowCatergoryView *)flowCatergoryView;

/** 即将结束滑动*/
- (void)flowCatergoryViewDidEndDecelerating:(BPSpecificFlowCatergoryView *)flowCatergoryView;

@end


@interface BPSpecificFlowCatergoryView : UIView

/**vc缓存*/
@property (nonatomic, strong,readonly) NSMutableDictionary *vcCacheDic;
/**代理*/
@property (nonatomic, weak) id<BPSpecificFlowCatergoryViewDelegate>delegate;
/**顶部高度*/
