...
@class BPFlowCatergoryImageTagView;

@protocol BPFlowCatergoryImageTagViewDelegate <NSObject>
 ...
 */
- (void)catergoryView:(BPFlowCatergoryImageTagView *)catergoryView didSelectItemAtIndexPath:(NSIndexPath *)indexPath;

@end


@interface BPFlowCatergoryImageTagView : UIView
...
/**代理，可监听item按钮点击*/
@property (nonatomic, assign) id<BPFlowCatergoryImageTagViewDelegate> delegate;
