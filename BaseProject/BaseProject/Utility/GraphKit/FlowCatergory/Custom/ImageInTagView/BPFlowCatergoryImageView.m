...
@interface BPFlowCatergoryImageView ()<UICollectionViewDataSource, UICollectionViewDelegate, BPFlowCatergoryImageTagViewDelegate>
@property (nonatomic, weak) UICollectionView *contentCollectionView;
@property (nonatomic, weak) BPFlowCatergoryImageTagView *catergoryView;
@property (nonatomic, strong,readwrite) NSMutableDictionary *vcCacheDic;
@end

@implementation BPFlowCatergoryImageView
...
- (void)configSubViews {
    ...
    //catergoryView
    BPFlowCatergoryImageTagView * catergoryView = [[BPFlowCatergoryImageTagView alloc] init];
    ...
    /* 关于cell 间距*/
    catergoryView.itemSpacing = 30;//item间距，默认10
