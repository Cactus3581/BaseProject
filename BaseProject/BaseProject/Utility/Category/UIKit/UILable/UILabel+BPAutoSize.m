...
- (UILabel *)bp_resizeLabelVertical{
    return [self bp_resizeLabelVertical:0];
}

- (UILabel *)bp_resizeLabelVertical:(CGFloat)minimumHeigh{
...
- (UILabel *)bp_resizeLabelHorizontal:(CGFloat)minimumWidth{
    CGRect newFrame = self.frame;
