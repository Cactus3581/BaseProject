...
- (UIImage *)bp_roundedCornerImage:(NSInteger)cornerSize borderSize:(NSInteger)borderSize {
    ...
    [self bp_addRoundedRectToPath:CGRectMake(borderSize, borderSize, image.size.width - borderSize * 2, image.size.height - borderSize * 2)
                       context:context
