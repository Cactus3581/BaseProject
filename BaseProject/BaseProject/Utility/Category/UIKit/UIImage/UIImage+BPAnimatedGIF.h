...
*/
@interface UIImage (BPAnimatedGIF)

/*
        UIImage *animation = [UIImage bp_animatedImageWithAnimatedGIFData:theData];
...
*/
+ (UIImage *)bp_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
        UIImage *image = [UIImagebp_ animatedImageWithAnimatedGIFURL:theURL];
...
*/
+ (UIImage *)bp_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
