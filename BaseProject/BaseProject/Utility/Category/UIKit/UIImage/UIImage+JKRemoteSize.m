...
@property (nonatomic, copy) JKUIImageSizeRequestCompleted bp_sizeRequestCompletion;
@end

@implementation NSURL (RemoteSize)

- (void)setBp_sizeRequestCompletion: (JKUIImageSizeRequestCompleted) block {
    objc_setAssociatedObject(self, &kSizeRequestCompletionKey, block, OBJC_ASSOCIATION_COPY);
}

- (JKUIImageSizeRequestCompleted)bp_sizeRequestCompletion {
