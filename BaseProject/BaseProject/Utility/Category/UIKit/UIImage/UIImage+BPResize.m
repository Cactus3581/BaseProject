...
- (CGAffineTransform)bp_transformForOrientation:(CGSize)newSize;
@end

@implementation UIImage (BPResize)
...
- (UIImage *)bp_thumbnailImage:(NSInteger)thumbnailSize
       ...
       interpolationQuality:(CGInterpolationQuality)quality {
    UIImage *resizedImage = [self bp_resizedImageWithContentMode:UIViewContentModeScaleAspectFill
    ...
    CGRect cropRect = CGRectMake(round((resizedImage.size.width - thumbnailSize) / 2),
                                 ...
                                 thumbnailSize,
                                 thumbnailSize);
    UIImage *croppedImage = [resizedImage bp_croppedImage:cropRect];
    
    UIImage *transparentBorderImage = borderSize ? [croppedImage bp_transparentBorderImage:borderSize] : croppedImage;

    return [transparentBorderImage bp_roundedCornerImage:cornerRadius borderSize:borderSize];
}
...
- (UIImage *)bp_resizedImage:(CGSize)newSize interpolationQuality:(CGInterpolationQuality)quality {
    ...
    return [self bp_resizedImage:newSize
                    transform:[self bp_transformForOrientation:newSize]
...
- (UIImage *)bp_resizedImageWithContentMode:(UIViewContentMode)contentMode
    ...
    return [self bp_resizedImage:newSize interpolationQuality:quality];
}
