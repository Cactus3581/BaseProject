...
@implementation UIView (BPCustomBorder)
...
- (void)bp_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self bp_addTopBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)bp_addLeftBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self bp_addLeftBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)bp_addBottomBorderWithColor:(UIColor *)color width:(CGFloat) borderWidth {
    [self bp_addBottomBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)bp_addRightBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self bp_addRightBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}
...
- (void)bp_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth excludePoint:(CGFloat)point edgeType:(BPExcludePoint)edge {
    ...
    if (edge & BPExcludeStartPoint) {
        startPoint += point;
    }
    
    if (edge & BPExcludeEndPoint) {
        endPoint += point;
    }
