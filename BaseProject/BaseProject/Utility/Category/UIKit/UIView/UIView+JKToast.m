...
- (void)bp_makeToast:(NSString *)message {
    [self bp_makeToast:message duration:JKToastDefaultDuration position:nil];
}
...
- (void)bp_showToast:(UIView *)toast {
    [self bp_showToast:toast duration:JKToastDefaultDuration position:nil];
}
...
- (void)bp_makeToastActivity {
    [self bp_makeToastActivity:JKToastActivityDefaultPosition];
}
