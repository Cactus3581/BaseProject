//
//  UISplitViewController+BPQuickAccess.m
//  BaseProject
//
...
@implementation UISplitViewController (BPQuickAccess)

- (UIViewController *)bp_leftController {
...
- (UIViewController *)bp_rightController {
