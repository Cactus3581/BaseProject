...
@implementation NSString (BPHTML)
...
- (NSString *)_stringByConvertingHTMLToPlainText {
    @autoreleasepool {
        ...
        NSCharacterSet *tagNameCharacters = [NSCharacterSet characterSetWithCharactersInString:@"abcdefghilmnopqrstuvwxyzABCDEFGHIBPLMNOPQRSTUVWXYZ"];
