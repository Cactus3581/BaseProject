...
BPSYNTH_DUMMY_CLASS(UIApplication_BPAdd)

@implementation UIApplication (BPAdd)
...
- (BOOL)isPirated {
    ...
    if (![self _bp_fileExistInMainBundle:@"_CodeSignature"]) {
        return YES;
    }
    
    if (![self _bp_fileExistInMainBundle:@"SC_Info"]) {
        return YES;
    }
...
- (BOOL)_bp_fileExistInMainBundle:(NSString *)name {
