...
BPSYNTH_DUMMY_CLASS(NSData_BPAdd)

@implementation NSData (BPAdd)
- (NSString *)md2String {
...
- (NSString *)bp_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)bp_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)bp_hmacMD5StringWithKey:(NSString *)key {
    return [self bp_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)bp_hmacMD5DataWithKey:(NSData *)key {
    return [self bp_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)bp_hmacSHA1StringWithKey:(NSString *)key {
    return [self bp_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)bp_hmacSHA1DataWithKey:(NSData *)key {
    return [self bp_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)bp_hmacSHA224StringWithKey:(NSString *)key {
    return [self bp_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)bp_hmacSHA224DataWithKey:(NSData *)key {
    return [self bp_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)bp_hmacSHA256StringWithKey:(NSString *)key {
    return [self bp_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)bp_hmacSHA256DataWithKey:(NSData *)key {
    return [self bp_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)bp_hmacSHA384StringWithKey:(NSString *)key {
    return [self bp_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)bp_hmacSHA384DataWithKey:(NSData *)key {
    return [self bp_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)bp_hmacSHA512StringWithKey:(NSString *)key {
    return [self bp_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)bp_hmacSHA512DataWithKey:(NSData *)key {
    return [self bp_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
+ (NSData *)bp_dataWithHexString:(NSString *)hexStr {
...
- (id)jsonValue{
    ...
    if (error) {
        BPLog(@"jsonValueDecoded error:%@", error);
    }
    return value;
}
