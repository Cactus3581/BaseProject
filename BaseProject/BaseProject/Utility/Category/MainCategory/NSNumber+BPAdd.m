...
BPSYNTH_DUMMY_CLASS(NSNumber_BPAdd)

@implementation NSNumber (BPAdd)


+ (NSNumber *)bp_numberWithString:(NSString *)string {
    NSString *str = [[string bp_stringByTrim] lowercaseString];
    if (!str || !str.length) {
        return nil;
    }
