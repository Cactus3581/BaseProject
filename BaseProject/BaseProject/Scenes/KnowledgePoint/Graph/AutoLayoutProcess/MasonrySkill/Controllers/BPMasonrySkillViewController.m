//
//  BPMasonrySkillViewController.m
//  BaseProject
//
...
#import "BPMasonrySkillViewController.h"
#import "BPMasonrySkillView.h"

#define SINGLE_LINE_WIDTH           (1 / [UIScreen mainScreen].scale)
#define SINGLE_LINE_ADJUST_OFFSET   ((1 / [UIScreen mainScreen].scale) / 2)

@interface BPMasonrySkillViewController ()
@property (nonatomic,strong) UIView *testview;
@property (nonatomic,strong) UILabel *testlabel;
@property (nonatomic,strong) BPMasonrySkillView *masonryView;
@end
...
@implementation BPMasonrySkillViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    //    [self differentjixing];
    
    //    [self.view addSubview:self.BPMasonrySkillView];
    ...
    //    [self.BPMasonrySkillView mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (BPMasonrySkillView *)masonryView
{
    if (!_masonryView) {
        _masonryView = [[BPMasonrySkillView alloc]init];
    }
    return _masonryView;
}
