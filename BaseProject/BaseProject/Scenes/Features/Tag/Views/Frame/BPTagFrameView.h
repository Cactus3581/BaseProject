...
@class BPTagFrameView;

@protocol BPTagFrameViewDelegate <NSObject>
@optional
- (void)tagLabelView:(BPTagFrameView *)tagLabelView didSelectRowAtIndex:(NSInteger)index;
@end

@interface BPTagFrameView : UIView
...
@property (nonatomic,weak) id <BPTagFrameViewDelegate> delegate;
