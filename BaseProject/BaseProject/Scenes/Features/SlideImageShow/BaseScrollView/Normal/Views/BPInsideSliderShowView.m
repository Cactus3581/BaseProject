...
@implementation BPInsideSliderShowView
...
- (void)initializeSubViewsFrame {
    ...
    /*
     ...
     CGFloat parentViewWidth(已知) = (kScreenWidth =) imageSizeW + inset*2;
     
     CGFloat scrollWidth = parentViewWidth - inset*2 + inset*2;
     
     CGFloat scrollWidth = parentViewWidth;
     CGFloat imageWidth = parentViewWidth - inset*2;
     */
