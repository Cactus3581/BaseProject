...
@protocol BPCardPageFlowViewDataSource;
@protocol BPCardPageFlowViewDelegate;
 ...
 *  默认为横向
 */
@property (nonatomic,assign) BPCardPageFlowViewOrientation orientation;
...
@protocol  BPCardPageFlowViewDelegate<NSObject>
...
@protocol BPCardPageFlowViewDataSource <NSObject>
