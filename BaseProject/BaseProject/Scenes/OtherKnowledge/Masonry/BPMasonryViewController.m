...
#import "BPMasonryViewController.h"
#import "BPMasonryView.h"

#define SINGLE_LINE_WIDTH           (1 / [UIScreen mainScreen].scale)
#define SINGLE_LINE_ADJUST_OFFSET   ((1 / [UIScreen mainScreen].scale) / 2)

@interface BPMasonryViewController ()
@property (nonatomic,strong) UIView *testview;
@property (nonatomic,strong) UILabel *testlabel;
@property (nonatomic,strong) BPMasonryView *masonryView;
...
@implementation BPMasonryViewController

- (void)viewDidLoad {
    [super viewDidLoad];
//    [self differentjixing];
    
//    [self.view addSubview:self.BPMasonryView];
...
//    [self.BPMasonryView mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (BPMasonryView *)masonryView
{
    if (!_masonryView) {
        _masonryView = [[BPMasonryView alloc]init];
    }
    return _masonryView;
}
