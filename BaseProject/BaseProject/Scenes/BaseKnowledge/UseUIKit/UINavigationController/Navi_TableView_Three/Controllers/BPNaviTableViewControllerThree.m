//
//  BPNaviTableViewControllerThree.m
//  BaseProject
//
...
#import "BPNaviTableViewControllerThree.h"
#import <Masonry.h>
...
@interface BPNaviTableViewControllerThree ()<UITableViewDataSource, UITabBarDelegate, UIScrollViewDelegate>
...
@implementation BPNaviTableViewControllerThree
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.imageView.image = [UIImage imageNamed:@"cactus_round_steady"];
    return cell;
}
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    UIImageView *imageview = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"cactus_round_steady"]];
...
- (void)setNavigationSubView{
    ...
    //    bgImgView.image = [UIImage imageNamed:@"cactus_round_steady"];
...
- (UIImageView *)scaleImageView {
    if (!_scaleImageView) {
        ...
        _scaleImageView.image = [UIImage imageNamed:@"cactus_round_steady"];
    }
