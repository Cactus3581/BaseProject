//
//  BPIncludeTableSelfSizeHeaderView.m
//  BaseProject
//
...
@interface BPIncludeTableSelfSizeHeaderView()
...
@property (strong, nonatomic) BPMultiLevelCatalogueModel1st *model;
@end

@implementation BPIncludeTableSelfSizeHeaderView
