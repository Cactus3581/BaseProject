...
+ (NSArray *)array {
    ...
    NSArray *photoImageArray = @[@"module_landscape1",@"module_landscape2",@"module_landscape3",@"module_landscape4",@"module_landscape5",@"module_landscape1",@"module_landscape2",@"module_landscape3",@"module_landscape4",@"module_landscape5"];
    NSArray *nameArray = @[@"module_landscape1",@"module_landscape2",@"module_landscape3",@"module_landscape4",@"module_landscape5",@"module_landscape1",@"module_landscape2",@"module_landscape3",@"module_landscape4",@"module_landscape5"];
//    NSArray *descArray = @[@"程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法，程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法，程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法",];
    NSArray *descArray = @[@"module_landscape1",@"module_landscape2",@"module_landscape3",@"module_landscape4",@"module_landscape5",@"module_landscape1",@"module_landscape2",@"module_landscape3",@"module_landscape4",@"module_landscape5"];
