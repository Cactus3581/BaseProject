//
//  BPCellHeightAutoLayoutTextViewTableViewCell.m
//  BaseProject
//
...
@interface BPCellHeightAutoLayoutTextViewTableViewCell()
@property (weak, nonatomic) IBOutlet UITextView *textView;

@end
@implementation BPCellHeightAutoLayoutTextViewTableViewCell
...
- (CGFloat)height3rdWithModel1:(BPCellAutoLayoutHeightModel *)model {
    BPCellHeightAutoLayoutTextViewTableViewCell *cell = [[BPCellHeightAutoLayoutTextViewTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"BPCellHeightAutoLayoutTextViewTableViewCell"];
