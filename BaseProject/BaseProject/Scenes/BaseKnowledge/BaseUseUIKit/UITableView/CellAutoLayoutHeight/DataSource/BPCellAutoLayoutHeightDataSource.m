...
+ (NSArray *)array {
    ...
    NSArray *photoImageArray = @[@"Yosemite00",@"Yosemite01",@"Yosemite02",@"Yosemite03",@"Yosemite04",@"Yosemite00",@"Yosemite01",@"Yosemite02",@"Yosemite03",@"Yosemite04"];
    NSArray *nameArray = @[@"Yosemite00",@"Yosemite01",@"Yosemite02",@"Yosemite03",@"Yosemite04",@"Yosemite00",@"Yosemite01",@"Yosemite02",@"Yosemite03",@"Yosemite04"];
//    NSArray *descArray = @[@"程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法，程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法，程序已经进入到后台执行的方法",@"程序已经进入到后台执行的方法",];
    NSArray *descArray = @[@"Yosemite00",@"Yosemite01",@"Yosemite02",@"Yosemite03",@"Yosemite04",@"Yosemite00",@"Yosemite01",@"Yosemite02",@"Yosemite03",@"Yosemite04"];
