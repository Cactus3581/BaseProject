...
@interface BP1STManualHeaderView()
...
@implementation BP1STManualHeaderView
...
- (void)setModel:(BPMultiLevelCatalogueModel1st *)model section:(NSInteger)section {
    ...
    [title_1st_attributedString addAttribute:NSForegroundColorAttributeName value:kDarkTextColor range:NSMakeRange(0, title_1st.length)];
    [number_name_attributedString addAttribute:NSForegroundColorAttributeName value:kLightGrayColor range:NSMakeRange(0, number.length)];
