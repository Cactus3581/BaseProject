//
//  BPMasonryAutoLayoutMoreDetailProcessViewController.m
//  BaseProject
//
//  Created by xiaruzhen on 2018/5/29.
//  Copyright © 2018年 cactus. All rights reserved.
//

#import "BPMasonryAutoLayoutMoreDetailProcessViewController.h"
...
@interface BPMasonryAutoLayoutMoreDetailProcessViewController ()
@property (nonatomic,weak) BPMasonryAutoLayoutProcessView *layoutView;
@end

@implementation BPMasonryAutoLayoutMoreDetailProcessViewController
...
- (BPMasonryAutoLayoutProcessView *)layoutView {
    if (!_layoutView) {
