...
@interface BPFlowCatergoryViewLayout ()
...
@implementation BPFlowCatergoryViewLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BPFlowCatergoryViewCellModel *model = _property.data[indexPath.item];
    //计算每个item的size
